...
namespace BinaryData
{
    ...
    const int            _5_Limit_sclSize = 102;

    extern const char*   _7_Limit_scl;
    const int            _7_Limit_sclSize = 100;

    extern const char*   Pythagorean_scl;
    const int            Pythagorean_sclSize = 123;
